...
This command **requires** the project directory as an argument via `/Users/marknance/dev/auto/sage`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/marknance/dev/auto/sage/.autoforge/prompts/app_spec.txt` and `/Users/marknance/dev/auto/sage/.autoforge/prompts/initializer_prompt.md`

If `/Users/marknance/dev/auto/sage` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/marknance/dev/auto/sage/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/marknance/dev/auto/sage/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/marknance/dev/auto/sage/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/marknance/dev/auto/sage/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/marknance/dev/auto/sage/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/marknance/dev/auto/sage/.autoforge/prompts/app_spec.txt`
> - `/Users/marknance/dev/auto/sage/.autoforge/prompts/initializer_prompt.md`
>
